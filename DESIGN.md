...
device`. The web and desktop harnesses (`scripts/verify-web-e2e.mjs`,
  ...
  `renameVaultField`, `renameVaultButton`, `moveFolderField`,
  `moveFolderButton`, `removeVaultButton`, `deleteVaultButton`,
  `confirmationField`, `confirmDestructiveButton`, `confirmCancelButton`,
  `signedInAsText`, `signOutButton`, `currentPassphraseField`,
  `newPassphraseField`, `newPassphraseConfirmField`, `changePassphraseButton`,
